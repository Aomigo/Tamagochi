...
SubSliderAdventure.forEach((button) => {
    button.addEventListener('click', function () {
        ...
        if (adventureCD == true) return null
        whileTrue = true
        setTimeout(() => {
            whileTrue = false
        }, 10000)
...
function feeding() {
    SubSliderFood.forEach((button) => {
        button.addEventListener('click', function () {
            ...
            if (button.textContent.includes(Diana.dislike)) {
            ...
            } else if (button.textContent.includes("Elixir")) {
                if (button.textContent.includes("Health")) {
                    ...
                    healthWrapper.style.width = TotalHapiness + "%"
                    setTimeout(() => {
                        HealHealth()
                    }, 500)

                    function HealHealth() {
                        healthBar.style.width = TotalHapiness + "%"
                    }
                ...
                if (button.textContent.includes("Mental")) {
                    ...
                    exhaustionWrapper.style.width = TotalHapiness + "%"
                    setTimeout(() => {
                        HealMental()
                    }, 500)

                    function HealMental() {
                        ExhaustionBar.style.width = TotalHapiness + "%"
                    }
