...
//While true sert a empecher d'appuyer sur un bouton pendant la transition
let whileTrue = false
//Sert a ajouter un cd quand on part en aventure
let adventureCD = false
//Sert a ajouter un cd quand on fait une action
let trainCD = false

//Pour les trois boutons, On verifie quel bouton est appuyé et on ouvre le menu si il n'y a pas de cd
Buttons.forEach((button) => {
    button.addEventListener('click', function () {
        if (button.classList.contains('button-adventure')) {
            //Si vrai, on affiche un message de cd
            if (adventureCD == true) {
        ...
        if(button.classList.contains('button-craft')) {
            console.log("hallo")
        }
    })
})
//Si un des boutons du menu est appuyé, on verifie si il y a un cooldown, si non on on part en aventure
...
//Si un des boutons du menu est appuyé, on verifie si il y a un cooldown, si non on mange
function feeding() {
    SubSliderFood.forEach((button) => {
        ...
        button.addEventListener('click', function () {
            ...
            //On enlève un des ingrédients si on en a plusieurs 
...
//Si un des boutons du menu est appuyé, on verifie si il y a un cooldown, si non on fait l'activité
